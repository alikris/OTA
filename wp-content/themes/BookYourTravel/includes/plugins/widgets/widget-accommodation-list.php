...
class byt_Accommodation_List_Widget extends WP_Widget {
	...
	function byt_Accommodation_List_Widget() {
		...
		/* Create the widget. */
		$this->WP_Widget( 'byt_accommodation_lists_widget', __('BookYourTravel: Accommodation List', 'bookyourtravel'), $widget_ops, $control_ops );
	}
