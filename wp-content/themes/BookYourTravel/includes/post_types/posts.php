...
class BYT_Posts_Post_Type extends BYT_BaseSingleton {
...
global $byt_posts_post_type;
// store the instance in a variable to be retrieved later and call init
$byt_posts_post_type = BYT_Posts_Post_Type::get_instance();
$byt_posts_post_type->init();