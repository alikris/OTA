...
global $byt_car_rentals_post_type, $byt_theme_globals;
...
$posts_per_page = $byt_theme_globals->get_car_rentals_archive_posts_per_page();
...
<section class="<?php echo esc_attr($section_class); ?>">
	...
	<?php endwhile; ?>
<?php		
	$car_rental_results = $byt_car_rentals_post_type->list_car_rentals($paged, $posts_per_page, 'post_title', 'ASC', 0, $car_type_ids);
?>	
